...
DOMAIN_TERMS: dict[str, list[str]] = {
    ...
    "אוורור": [
        ...
        "שדרוג סינון אויר",
        "מערכות אויר רפואי",
        "מאוררי אוויר רפואיים",
        "מערכות טיהור אויר",
        "יחידות סינון רפואיות",
        "סינון חלקיקים רפואי",
        "מסנני HEPA רפואיים",
        "מערכות אוורור בקורה",
        "מערכות אוורור מבוקרת",
    ],
    "פינוי עשן": [
        "פינוי עשן",
        "מערכת פינוי עשן",
        ...
        "מערכות בטיחות",
        "יחידות סינון עשן",
        "בדיקת פינוי עשן שנתית",
        "ביקורות כבאיות",
        "בדיקות בטיחות עשן",
        "שירות תחזוקת מערכות עשן",
        "בדיקות דוריות פינוי",
    ],
}
...
SUBJECT_DOMAIN_MAP: dict[str, list[str]] = {
    ...
    "שירותי בדיקה תקופתית וביקורות": ["מיזוג אויר", "קירור", "אוורור", "פינוי עשן"],
    "מערכות אוורור ואוויר רפואי": ["אוורור", "מיזוג אויר"],
    "מערכות טיהור וסינון אויר": ["אוורור", "מיזוג אויר"],
    "שירותי תפעול וניהול מבנים": ["מיזוג אויר", "קירור", "אוורור", "פינוי עשן"],
    "חוזי שירות מכניים למבנים": ["מיזוג אויר", "קירור", "אוורור"],
}
...
NEGATIVE_PATTERNS: list[str] = [
    ...
    "הובלה בקירור",
    "שירותי הובלה בקירור",
    "ספרינקלרים רטובה ויבשה",
    "בדיקות כיבוי אש",
    "תחזוקת מערכות כיבוי",
    "מערכות בטיחות אש",
    "דלתות עמידות אש",
    "בדיקות בטיחות כלליות",
    "טיפול במים - CQM",
    "ניהול פרויקטים בנייה",
    "ייעוץ בניהול כללי",
    "גמרים בנייה כללי",
]
